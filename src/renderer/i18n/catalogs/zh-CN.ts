...
export const zhCN = {
  ...
  settings: {
    ...
    libraryIgnore: "忽略规则",
    libraryIgnoreHint: "使用资源库目录下的 .gitignore 管理隐藏的文件和文件夹。",
    gitignoreFile: ".gitignore 文件",
    gitignoreFileHint: "编辑后立即保存到资源库目录，并应用于浏览、搜索和扫描。",
    gitignoreSyntax: "支持注释（#）、通配符（*、?、**）、目录规则（末尾 /）、根目录规则（开头 /）和否定规则（!）。",
