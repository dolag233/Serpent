...
export const zhCN = {
  ...
  menu: {
    ...
    skipLinked: "{count} 项链接资产不由资源库管理",
    skipUnavailableManaged: "{count} 项托管资产当前不可用",
    skipUnresolved: "{count} 项资产已不在当前范围",
    skipPrefix: "，跳过{reasons}",
    moveCopySummary: "移动/复制处理 {count} 项可用托管资产",
