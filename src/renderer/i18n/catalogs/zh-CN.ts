...
export const zhCN = {
  ...
  settings: {
    ...
    themeProfiles: "主题预设",
    themeProfilesHint: "选择一套完整的语义颜色系统，预览和插件界面会立即同步。",
    themeProfileVscodeDark: "VS Code 深色",
    themeProfileSerpentDark: "Serpent 深色",
    themeProfileSerpentLight: "Serpent 亮色",
    themeProfileSoftLight: "柔和亮色",
    backgroundSection: "应用背景",
    backgroundSectionHint: "为应用壳配置背景颜色或图片，并调整保证文字可读性的叠加层。",
    backgroundPreview: "应用背景预览",
    backgroundColor: "背景颜色",
    backgroundMode: "图片适配",
    backgroundModeCover: "覆盖",
    backgroundModeContain: "适应",
    backgroundModeTile: "平铺",
    backgroundChooseImage: "选择背景图片",
    backgroundReplaceImage: "替换背景图片",
    backgroundRemoveImage: "移除图片",
    backgroundOverlay: "可读性叠加层",
    backgroundOverlayHint: "使用主题色的叠加层，保证图片上的文字和控件清晰可读。",
    backgroundSaveError: "背景无法保存，图片可能超过本地存储容量。",
    backgroundImageTooLarge: "图片太大，请选择小于 3 MB 的图片。",
    backgroundImageUnsupported: "请选择支持的栅格图片（PNG、JPEG、WebP、GIF、BMP 或 AVIF）。",
    backgroundReset: "恢复应用背景",
    backgroundStorageHint: "图片保存在本机设置中（最大 {size} MB）。",
    accentColor: "强调色",
    accentHint: "控制按钮、选中环、焦点、过滤启用态与拖放高亮等主色调；立即生效并跨重启保存。卡片尺寸滑块等连续控件保持中性色。",
    accentCustom: "自定义强调色（#RRGGBB）",
    accentReset: "恢复默认",
    customTheme: "主题颜色覆盖",
    customThemeHint: "覆盖当前亮/暗主题的常用语义颜色；仅影响颜色，不改变布局、字体和层级。",
    customThemeReset: "清除颜色覆盖",
    customThemeCanvas: "画布背景",
    customThemePane: "面板背景",
    customThemeRaised: "卡片背景",
    customThemePrimary: "主要文字",
    customThemeSecondary: "次要文字",
    customThemeAccent: "操作强调色",
