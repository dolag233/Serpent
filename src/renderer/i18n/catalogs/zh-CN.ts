...
export const zhCN = {
  ...
  settings: {
    ...
    mcpPermissionsHint: "Auto 模式不弹普通权限提示；Full Access 在一次危险警告后也跳过 Agent 的危险操作二次确认。",
    mcpPermissionClientHint: "模式会跨应用重启保留，仅作用于这个客户端凭据。",
    mcpAccessMode: "访问模式",
    mcpAccessModeAuto: "Auto",
    mcpAccessModeFull: "Full Access",
    mcpAccessModeAutoHint: "普通和可恢复操作直接执行；危险操作需要 Agent 进行第二次确认。",
    mcpAccessModeFullHint: "所有 MCP 操作直接执行，包括危险操作。Serpent 仍会执行路径、目标、版本和 Worker 安全校验。",
