...
export const zhCN = {
  ...
  settings: {
    ...
    pluginSafeMode: "安全模式",
    pluginSafeModeHint: "暂时停用所有第三方插件，不会卸载或删除它们。",
    pluginInstall: "安装插件",
    ...
    pluginRuntimeTrusted: "可信运行时",
    pluginRuntimeTrustedHint: "可信运行时使用完整 Node.js 能力，可读写本机文件、访问网络并启动其他程序。声明的权限只能约束经 Serpent Gateway 的命令，不能当作系统沙箱。仅信任来源明确、你愿意授予本机完整能力的插件。",
    pluginRuntimeStandard: "标准运行时",
    pluginRuntimeStandardHint: "标准运行时在独立进程的受限沙箱中执行，只能调用你授权的 Gateway 命令。",
    pluginTrustTrustedConfirmHint: "信任后，此插件将获得本机完整系统能力。",
