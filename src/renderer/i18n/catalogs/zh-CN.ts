...
export const zhCN = {
  ...
  aiConfig: {
    title: "AI 配置",
    note: "此模型用于：资产 AI 分析（自动生成描述、标签等），以及自然语言 AI 搜索。",
    provider: "供应商",
    apiFormat: "API 格式",
    ...
    language: "语言",
    languageHint: "分析与 AI 搜索按所选语言生成描述、标签与关键词；标签语言须与所选语言一致。",
  ...
  settings: {
    ...
    categoryGeneral: "常规",
    categoryGeneralDescription: "语言与基本使用偏好",
    categoryAppearance: "外观",
    categoryAppearanceDescription: "主题、强调色与层级投影",
    categoryBrowse: "浏览",
    categoryBrowseDescription: "资产画布与卡片信息",
    categoryAi: "AI",
