...
export const zhCN = {
  ...
  shell: {
    ...
    networkStorageNotice: "该资源库位于网络共享（NAS）上。可能出现加载较慢等问题。",
  ...
  command: {
    asset: {
      ...
      // 链接资产只有这一个删除动作（2026-09-15 用户决定）：真的从硬盘删掉源文件。
    ...
    assets: {
      ...
      forceDeleteFromDisk: "强制从硬盘删除（{count} 项）",
      ...
      copy: "复制（{count} 项）",
      // Serpent-d7acfa：多选里对文件夹生效的批量项（计数只算真正能做的文件夹）。
      appearance: "设置图标与颜色…（{count} 项）",
      ignore: "忽略（{count} 项）"
    },
    folder: {
      newSubfolder: "新建子文件夹",
      ...
      moveToTrash: "移入回收站",
      deleteFromDisk: "从硬盘中删除…",
      // 2026-09-15 用户决定：链接文件夹不再有「移入回收站」。改为两个动作——
      // 移除 = 只删链接记录（不碰外部源目录）；强制删除 = 真的从硬盘删掉。
      forceDeleteFromDisk: "强制从硬盘删除…",
  ...
  inspector: {
    ...
    fontFormat: "{format} 字体",
    fontFamily: "家族",
    fontStyle: "样式",
    fontVersion: "版本",
    fontWeight: "字重",
    fontGlyphs: "字形数",
    fontUnitsPerEm: "em 单位",
    fontScript: "字符集",
    fontManufacturer: "厂商",
    fontScriptJa: "日文",
    fontScriptZhHans: "简体中文",
    fontScriptZhHant: "繁体中文",
    fontScriptKo: "韩文",
    fontScriptLatin: "拉丁文",
    ...
    rawTitle: "标题",
    rawDescription: "描述",
    rawGpsLatitude: "GPS 纬度",
    rawGpsLongitude: "GPS 经度",
    rawOrientation: "方向",
    embeddedTitle: "标题",
    embeddedArtist: "艺术家",
    embeddedAlbum: "专辑",
    embeddedAlbumArtist: "专辑艺术家",
    embeddedTrack: "曲目",
    embeddedDisc: "唱片",
    embeddedGenre: "流派",
    embeddedComposer: "作曲家",
    embeddedDate: "日期",
    embeddedComment: "备注",
    embeddedCopyright: "版权",
  ...
  dialog: {
    ...
    imageSequenceImport: {
      ...
      preview: "预览",
      previewAlt: "序列帧预览",
      previewCaption: "当前第 {frame} 帧 · 范围 {count} 帧 · {fps} FPS",
      previewUnavailable: "这一组暂时没有可预览的帧。",
      importSelected: "导入单独文件",
      importSequence: "导入序列帧",
      importing: "正在导入…",
      groupTitle: "导入序列帧",
      groupSummary:
        "导入的文件里有「{name}」（{count} 帧，{width}×{height}）。确认范围和帧率后导入为序列帧。",
  ...
  settings: {
    ...
    pluginCommunityHint: "浏览官方插件与经过认证的第三方插件",
    pluginCommunityOpen: "打开插件社区",
    pluginCommunityBack: "返回",
    pluginCommunitySearch: "搜索插件",
    pluginCommunityEmpty: "没有符合条件的插件。",
    pluginCommunityStale: "目录未能刷新，正在显示上次下载的列表。",
    pluginCommunityOfficial: "官方",
    pluginCommunityCertified: "已认证",
    pluginCommunityRemoved: "已撤架",
    pluginCommunityRemovedHint: "该插件已从官方目录撤架。再次信任或更新前请确认来源。",
    pluginCommunityInstall: "安装",
    pluginCommunityInstallNamed: "安装「{name}」",
    pluginCommunityInstalled: "已安装",
    pluginCommunityUpdate: "更新",
    pluginCommunityUpdateNamed: "更新「{name}」",
    pluginCommunityNoPlatform: "当前平台没有安装包。",
    pluginCommunityAdvanced: "高级安装",
    pluginCommunityViewDetails: "查看详情",
    pluginCommunityAuthor: "作者",
    pluginCommunityVersion: "版本",
    pluginCommunityRepository: "仓库",
    pluginCommunityRuntime: "运行模式",
    pluginCommunityPlatforms: "平台",
    pluginCommunityReadme: "说明",
    pluginCommunityReadmeLoading: "正在加载说明…",
    pluginCommunityReadmeMissing: "这个版本没有说明文档。",
    pluginCommunityReadmeUnavailable: "说明文档暂时无法加载。",
    pluginCommunityReadmeImage: "打开图片",
    ...
    pluginInstallLocalZipAction: "安装 ZIP",
    pluginInstallLocalZipHint: "选择插件 ZIP 压缩包。",
    pluginInstallLocalFolderAction: "安装文件夹",
    pluginInstallLocalFolderHint: "选择含 serpent-plugin.json 的插件文件夹。",
    ...
    themeProfileSoft: "柔和",
    themeAccent: "主题色",
    themeAccentHint: "快速搭配当前主题的强调色，点击后立即生效。",
    themeAccentBlue: "蓝色",
    themeAccentIndigo: "靛蓝",
    themeAccentPurple: "紫色",
    themeAccentPink: "粉色",
    themeAccentOrange: "橙色",
    themeAccentGreen: "绿色",
    themeAccentTeal: "青色",
    themeAccentRed: "红色",
    ...
    fontSize: "字体大小",
    fontSizeHint: "只调整 Serpent 界面文字，不改变系统或显示器缩放。",
    fontSizeCompact: "紧凑",
    fontSizeDefault: "默认",
    ...
    sync: {
      ...
      showCardStatus: "在卡片上显示同步状态",
      showCardStatusHint: "未同步的文件会在卡片上显示状态。",
      cardStatusPending: "等待同步",
      cardStatusConflict: "本地和云端冲突",
    ...
    gitignoreFileHint: "对资源库内资产、文件夹和扩展名执行的忽略会写入这里。点保存后才会应用到浏览、搜索和扫描。",
    gitignoreSyntax: "每行写一条规则。\n例如：*.tmp 忽略所有 .tmp 文件；参考/草稿/ 忽略“参考/草稿”文件夹；.*/ 隐藏所有名称以“.”开头的文件夹；!Assets/参考/草稿/保留.png 保留某个文件。\n支持 Git 风格规则：# 注释、* 和 ? 通配符、** 跨目录匹配、末尾 / 仅匹配文件夹、开头 / 限定资源库根目录，以及 ! 取消忽略。",
    gitignoreSaveHint: "只有点保存才会生效；点空白处不会保存。",
    gitignorePreview: "预览",
    gitignorePreviewCurrent: "当前忽略",
    gitignorePreviewAfterSave: "保存后",
    gitignorePreviewEmpty: "没有忽略的项目",
    gitignorePreviewSummary: "当前忽略 {current} 项",
    gitignorePreviewSummaryDiff: "当前忽略 {current} 项，将会新增 {added} 项，将会显示 {removed} 项",
    gitignorePreviewTruncated: "列表只显示前 {limit} 项",
  ...
  viewer: {
    ...
    fontPreview: "字体预览",
    fontPreviewLoading: "正在加载字体…",
    fontPreviewUnavailable: "无法预览这个字体文件。",
    fontPreviewText: "预览文字",
    fontPreviewSize: "字号 {size} px",
    fontPreviewWeight: "字重",
    fontPreviewWeightValue: "{weight}",
    fontPreviewLanguage: "语言",
    fontPreviewTextReset: "恢复默认文字",
    fontPreviewBold: "粗体",
    fontPreviewItalic: "斜体",
    fontPreviewUnderline: "下划线"
  },
  fontPreviewLanguage: {
    en: "英文",
    "zh-Hans": "简体中文",
  ...
  progress: {
    ...
    processingFiles: "处理中 {processed}/{total} · {bytesProcessed}/{bytesTotal}",
    deletingAssets: "正在删除",
    trashingAssets: "正在移到回收站",
    purgingTrash: "正在清空回收站",
    removingLinkedFolder: "正在移除链接文件夹",
    deletingFiles: "已处理 {processed}/{total}",
    deleting: "正在删除文件…",
    validating: "验证中…",
    ...
    processing: "处理中…",
    extracting: "正在解压…",
    extractingFiles: "正在解压 {processed}/{total}…",
    verifying: "正在校验…",
    verifyingFiles: "正在校验 {processed}/{total}…",
    opening: "打开中…",
    exportingLibrary: "正在导出资源库：",
    importingLibrary: "导入资源库：",
    importingAssets: "正在导入",
    importingStarted: "正在准备导入…",
  ...
  toast: {
    ...
    tagsAppliedCount: "已添加 {count} 个标签。",
    ...
    libraryDeleteCancelled: "已取消从硬盘删除资源库。",
    libraryRemoved: "已移除资源库「{name}」（磁盘文件未删除）。",
    libraryRemoveFailed: "移除资源库失败。",
    linkedFolderRemoved: "已移除链接文件夹「{name}」（{count} 项记录）；只删除了链接记录，源目录与其中的文件未改动。",
    ...
    permanentDeleteCancelled: "已取消永久删除。",
    emptyTrashSkipped: "，{count} 项未清理：{reasons}",
    emptyTrashFailed: "清空回收站失败。",
    emptyTrashCancelled: "已取消清空回收站。",
    ...
    cancellingDiskDelete: "正在取消删除…",
    cancelDiskDeleteFailed: "无法取消删除。",
    diskDeleteCancelled: "已取消从硬盘删除。",
  ...
  error: {
    code: {
      ...
      INVALID_APPEARANCE: "请从可用选项中选择图标或颜色。",
      ...
      ASSET_ALREADY_TRASHED: "该资产已经在回收站里了。请从回收站恢复，或在回收站中永久删除。",
      ASSET_NOT_TRASHED: "该资产不在回收站里，可能已经被恢复。请刷新回收站列表后重试。",
      ASSET_NOT_MANAGED: "该文件在链接文件夹里，不在资源库自己的存储中。Serpent 不会移动或删除链接文件夹里的文件，请在文件管理器中处理。",
      INVALID_STATE_TRANSITION: "资源库当前的状态不支持这一步（可能有另一个窗口或后台任务刚改过它）。请刷新磁盘变化后重试。",
      ...
      UNSUPPORTED_MEDIA_TYPE: "这类文件不支持这项操作。请改选受支持的文件类型。",
      CONFIRMATION_REQUIRED: "这项操作需要先确认。请重新打开对话框并确认后再试。",
      ASSET_CONTENT_INVALID: "这个文件的内容不是文本（可能是二进制或已损坏），文本视图无法打开它。如果它本应是文本，请检查文件是否完整。",
      IMPORT_AWAITING_DECISION: "这次导入还在等你决定怎么处理读不到的文件。请先回答那个提示，再继续。",
      AI_SETTINGS_INCOMPLETE: "自动分析还没开启：请先在 AI 设置里填入 API Key、选择模型，然后重试。",
    ...
    reason: {
      ...
      UNSUPPORTED_FORMAT: "Serpent 目前还不能处理这种文件格式。",
      ...
      AI_INVALID_RESPONSE: "AI 服务没有给出可用的分析结果。请换一个模型后再试。",
      AI_REQUEST_REJECTED: "AI 服务拒绝了这次分析请求。请到 AI 设置里换一个模型，或改用该服务支持的接口后再试。",
      ...
      IMAGE_SEQUENCE_SELECTION: "创建序列图需要同一文件夹内、文件名按编号连续的一组图片（至少 3 张）。",
      PERMANENT_DELETE_NEEDS_TRASH: "永久删除只对回收站里的资产生效：请先把它移入回收站。",
