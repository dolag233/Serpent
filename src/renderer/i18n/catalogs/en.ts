...
export const en = {
  ...
  settings: {
    ...
    pluginSafeModeHint: "Temporarily disable unrestricted-mode plugins. Restricted-mode plugins can keep running. Nothing is uninstalled.",
    pluginInstall: "Install plugin",
    pluginInstallHint: "Install an already-built local folder or ZIP, or a repository that already contains its compiled dist files.",
    ...
    pluginRuntimeTrusted: "Unrestricted mode",
    pluginRuntimeTrustedHint: "Unrestricted mode has full Node.js capability: it can read and write local files, use the network, and start other programs. Risk is higher. Declared permissions only limit Serpent Gateway commands and are not a system sandbox. Confirm the source, then use carefully.",
    ...
    pluginTrustTrustedConfirmHint: "After you trust it, this unrestricted-mode plugin will have full system capability on this device. Confirm carefully.",
    ...
    pluginThemeTrustedCssTrustHint: "Host CSS in unrestricted mode can modify the Serpent interface outside plugin iframes. Only trust plugins whose styling changes you accept.",
    ...
    pluginStatusSafeMode: "Disabled by Safe Mode (unrestricted)",
