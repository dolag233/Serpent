...
export const en = {
  ...
  settings: {
    ...
    pluginAutoUpdateHint: "Download newer GitHub Release builds for this plugin when settings refresh. Off by default.",
    ...
    mcpPermissionsHint: "Auto runs ordinary work without prompts. Full Access also skips the Agent's dangerous-operation handshake after one warning.",
    mcpPermissionClientHint: "This mode persists across app restarts and applies only to this client credential.",
    mcpAccessMode: "Access mode",
    mcpAccessModeReadOnly: "Read-only",
    mcpAccessModeReadWrite: "Read-write",
    mcpAccessModeFull: "Full access",
    mcpAccessModeReadOnlyHint: "Read and search only; write attempts show a desktop confirmation.",
    mcpAccessModeReadWriteHint: "Ordinary and recoverable operations run directly. Dangerous operations (e.g. permanent delete) require a second Agent confirmation.",
    mcpAccessModeFullHint: "All MCP operations run directly, including dangerous operations (e.g. permanent delete). Only enable this for clients you trust; Serpent still enforces path, target, version and worker safety checks.",
    mcpCopyCredential: "Copy",
    ...
    mcpConfigHint: "Create a credential and copy a configuration containing the endpoint and Bearer token to the clipboard.",
    mcpConfigFormat: "Configuration format",
    mcpConfigGeneric: "Generic JSON",
    mcpConfigEndpoint: "Endpoint + token",
    mcpCopyConfig: "Copy configuration",
    mcpConfigCopied: "MCP configuration copied to the clipboard.",
    mcpCredentialsTitle: "Client credentials",
    mcpCredentialsHint: "Tokens are stored only in Serpent’s private user-data directory. Revoke a token when a client no longer needs access.",
    mcpRevoke: "Revoke",
    mcpRevoked: "Revoked",
    mcpNoCredentials: "No client credentials have been created.",
