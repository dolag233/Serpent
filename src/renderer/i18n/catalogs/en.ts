...
export const en = {
  ...
  shell: {
    ...
    networkStorageNotice:
      "This library is on a network share (NAS). Loading may be slower.",
    readOnlyBanner:
  ...
  command: {
    ...
    assets: {
      ...
      copy: "Copy ({count})",
      // Serpent-d7acfa: batch items that act on selected folder cards.
      appearance: "Set icon & color… ({count})",
      ignore: "Ignore ({count})"
    },
    folder: {
  ...
  inspector: {
    ...
    fontWeight: "Weight",
    fontGlyphs: "Glyphs",
    fontUnitsPerEm: "Units per em",
    fontScript: "Script",
    fontManufacturer: "Manufacturer",
    fontScriptJa: "Japanese",
    fontScriptZhHans: "Simplified Chinese",
    fontScriptZhHant: "Traditional Chinese",
    fontScriptKo: "Korean",
    fontScriptLatin: "Latin",
    ...
    rawGpsLatitude: "GPS latitude",
    rawGpsLongitude: "GPS longitude",
    rawOrientation: "Orientation",
    embeddedTitle: "Title",
    embeddedArtist: "Artist",
    embeddedAlbum: "Album",
    embeddedAlbumArtist: "Album artist",
    embeddedTrack: "Track",
    embeddedDisc: "Disc",
    embeddedGenre: "Genre",
    embeddedComposer: "Composer",
    embeddedDate: "Date",
  ...
  dialog: {
    ...
    imageSequenceImport: {
      ...
      preview: "Preview",
      previewAlt: "Image sequence preview",
      previewCaption: "Frame {frame} · {count} frames in range · {fps} FPS",
      previewUnavailable: "This sequence has no frames to preview yet.",
      importSelected: "Import individual file",
      importSequence: "Import image sequence",
      importing: "Importing…",
      groupTitle: "Import image sequence",
      groupSummary:
        "Imported files include “{name}” ({count} frames, {width}×{height}). Confirm the range and frame rate to import them as a sequence.",
      keepSeparate: "Keep as separate files",
      makeSequence: "Import as image sequence",
      grouping: "Working…"
    },
    sourceFailure: {
  ...
  settings: {
    ...
    pluginCommunity: "Plugin community",
    pluginCommunityHint: "Browse official plugins and certified third-party plugins.",
    pluginCommunityOpen: "Browse community",
    pluginCommunityBack: "Back",
    pluginCommunitySearch: "Search plugins",
    pluginCommunityEmpty: "No plugins match this search.",
    pluginCommunityStale: "Could not refresh the directory. Showing the last downloaded list.",
    pluginCommunityOfficial: "Official",
    pluginCommunityCertified: "Certified",
    pluginCommunityRemoved: "Removed from directory",
    pluginCommunityRemovedHint: "This plugin was removed from the official directory. Review it before trusting or updating.",
    pluginCommunityInstall: "Install",
    pluginCommunityInstallNamed: "Install “{name}”",
    pluginCommunityInstalled: "Installed",
    pluginCommunityUpdate: "Update",
    pluginCommunityUpdateNamed: "Update “{name}”",
    pluginCommunityNoPlatform: "No package for this platform.",
    pluginCommunityAdvanced: "Advanced install",
    pluginCommunityViewDetails: "View details",
    pluginCommunityAuthor: "Author",
    pluginCommunityVersion: "Version",
    pluginCommunityRepository: "Repository",
    pluginCommunityRuntime: "Runtime",
    pluginCommunityPlatforms: "Platforms",
    pluginCommunityReadme: "Readme",
    pluginCommunityReadmeLoading: "Loading readme…",
    pluginCommunityReadmeMissing: "This release has no readme.",
    pluginCommunityReadmeUnavailable: "The readme could not be loaded.",
    pluginCommunityReadmeImage: "Open image",
    ...
    themeAccentHint: "Quickly pair the current theme with an accent color. Changes apply immediately.",
    themeAccentBlue: "Blue",
    themeAccentIndigo: "Indigo",
    themeAccentPurple: "Purple",
    themeAccentPink: "Pink",
    ...
    advancedColors: "Advanced color configuration",
    ...
    fontSize: "Font size",
    fontSizeHint: "Adjust Serpent UI text without changing OS or display scaling.",
    ...
    sync: {
      ...
      showCardStatus: "Show sync status on cards",
      showCardStatusHint: "Unsynced files show their status on the card.",
      cardStatusPending: "Waiting to sync",
      cardStatusConflict: "Local and cloud conflict",
    ...
    gitignoreFileHint: "Ignore actions for assets, folders, and extensions in this library are written here. They apply to browsing, search, and scans after you save.",
    gitignoreSyntax: "Write one rule per line.\nExamples: *.tmp ignores .tmp files; drafts/ ignores that folder; .*/ hides folders whose names start with '.'; !Assets/drafts/keep.png keeps one file visible.\nUses Git-style rules: comments (#), * and ? wildcards, ** across folders, a trailing / for folders only, a leading / for library-root rules, and ! to unignore.",
    gitignoreSaveHint: "Only Save applies the changes; clicking elsewhere does not save.",
    gitignorePreview: "Preview",
    gitignorePreviewCurrent: "Currently ignored",
    gitignorePreviewAfterSave: "After save",
    gitignorePreviewEmpty: "Nothing is ignored",
    gitignorePreviewSummary: "{current} currently ignored",
    gitignorePreviewSummaryDiff: "{current} currently ignored, {added} will be hidden, {removed} will be shown again",
    gitignorePreviewTruncated: "Showing the first {limit} items",
  ...
  viewer: {
    ...
    fontPreviewLoading: "Loading font…",
    fontPreviewUnavailable: "This font file cannot be previewed.",
    fontPreviewText: "Preview text",
    fontPreviewSize: "Size {size} px",
    fontPreviewWeight: "Weight",
    fontPreviewWeightValue: "{weight}",
    fontPreviewLanguage: "Language",
    fontPreviewTextReset: "Reset preview text",
    fontPreviewBold: "Bold",
    fontPreviewItalic: "Italic",
    fontPreviewUnderline: "Underline"
  },
  fontPreviewLanguage: {
    en: "English",
  ...
  progress: {
    ...
    processingFiles: "Processing {processed}/{total} · {bytesProcessed}/{bytesTotal}",
    ...
    extractingFiles: "Extracting {processed}/{total}…",
    verifying: "Verifying…",
    verifyingFiles: "Verifying {processed}/{total}…",
    opening: "Opening…",
    exportingLibrary: "Exporting library:",
    importingLibrary: "Importing library:",
    importingAssets: "Importing",
    importingStarted: "Preparing import…",
  ...
  toast: {
    ...
    libraryDeleteCancelled: "Cancelled deleting the library from disk.",
    ...
    permanentDeleteCancelled: "Cancelled permanent delete.",
    emptyTrashSkipped: ", {count} not cleaned: {reasons}",
    emptyTrashFailed: "Failed to empty Trash.",
    emptyTrashCancelled: "Cancelled emptying Trash.",
    ...
    cancellingDiskDelete: "Cancelling delete…",
    cancelDiskDeleteFailed: "Could not cancel delete.",
    diskDeleteCancelled: "Cancelled deleting from disk.",
    ...
    appearanceFailed: "Could not update the icon and color.",
  ...
  error: {
    code: {
      ...
      ASSET_ALREADY_TRASHED: "That asset is already in the trash. Restore it, or delete it permanently from the trash.",
      ASSET_NOT_TRASHED: "That asset is not in the trash — it may already have been restored. Refresh the trash list and try again.",
      ASSET_NOT_MANAGED: "That file lives in a linked folder, outside the library’s own storage. Serpent leaves those files where they are — handle it in your file manager.",
      INVALID_STATE_TRANSITION: "That action is not valid in the library’s current state, which another window or background task may have changed. Refresh disk changes and try again.",
      INVALID_SELECTION: "The selected items cannot be used for this action. Reselect them, or refresh the list and try again.",
      ASSET_STATE_CONFLICT: "This asset is not in a state that supports this action — it may have been deleted, restored, or changed elsewhere. Refresh the list and try again.",
      INVALID_ASSET_FILE_NAME: "Enter a file name that is safe across platforms.",
      UNSUPPORTED_MEDIA_TYPE: "This kind of file does not support that action. Choose a supported file type instead.",
      CONFIRMATION_REQUIRED: "That action needs confirmation first. Reopen the dialog, confirm it, and try again.",
      ASSET_CONTENT_INVALID: "This file’s content is not text — it may be binary or damaged, so the text view cannot open it. If it should be text, check that the file is intact.",
      IMPORT_AWAITING_DECISION: "This import is still waiting for you to decide what to do with the files that could not be read. Answer that prompt first, then continue.",
      AI_SETTINGS_INCOMPLETE: "Automatic analysis is not on yet. Add an API key and choose a model in AI settings, then try again.",
    ...
    reason: {
      ...
      UNSUPPORTED_FORMAT: "Serpent cannot handle this file format yet.",
      ...
      AI_INVALID_RESPONSE: "The AI service did not return a usable analysis. Try another model.",
      AI_REQUEST_REJECTED: "The AI service rejected this analysis request. Choose another model in AI settings, or switch to an API format the service supports.",
      ...
      IMAGE_SEQUENCE_SELECTION: "Creating an image sequence needs at least three images in one folder whose names share one numbering pattern.",
      PERMANENT_DELETE_NEEDS_TRASH: "Permanent delete only applies to assets in the trash. Move it to the trash first.",
