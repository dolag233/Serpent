...
export const en = {
  ...
  error: {
    code: {
      ...
      LIBRARY_READ_ONLY: "Serpent cannot write to this library. Check that the files are not locked or marked read-only.",
      ...
      LIBRARY_MIGRATION_STUCK: "This library could not be migrated after repeated attempts. Serpent opened it at the last working schema so you can keep using it.",
