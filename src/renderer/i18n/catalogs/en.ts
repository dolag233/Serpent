...
export const en = {
  ...
  settings: {
    ...
    mcpAccessModeAutoHint: "Ordinary and recoverable operations run directly. Dangerous operations require a second Agent confirmation.",
    mcpAccessModeFullHint: "All MCP operations run directly, including dangerous operations. Serpent still enforces path, target, version and worker safety checks.",
