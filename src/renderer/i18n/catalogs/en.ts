...
export const en = {
  ...
  settings: {
    ...
    themeProfiles: "Theme profiles",
    themeProfilesHint: "Choose a complete semantic color system. The preview and plugin UI update immediately.",
    themeProfileVscodeDark: "VS Code Dark",
    themeProfileSerpentDark: "Serpent Dark",
    themeProfileSerpentLight: "Serpent Light",
    themeProfileSoftLight: "Soft Light",
    backgroundSection: "App background",
    backgroundSectionHint: "Set a background color or image for the application shell and control the readability overlay.",
    backgroundPreview: "Application background preview",
    backgroundColor: "Background color",
    backgroundMode: "Image fit",
    backgroundModeCover: "Cover",
    backgroundModeContain: "Contain",
    backgroundModeTile: "Tile",
    backgroundChooseImage: "Choose background image",
    backgroundReplaceImage: "Replace background image",
    backgroundRemoveImage: "Remove image",
    backgroundOverlay: "Readability overlay",
    backgroundOverlayHint: "A theme-colored veil keeps text and controls readable over the image.",
    backgroundSaveError: "The background could not be saved. The image may be too large for local storage.",
    backgroundImageTooLarge: "This image is too large. Choose an image below 3 MB.",
    backgroundImageUnsupported: "Choose a supported raster image (PNG, JPEG, WebP, GIF, BMP, or AVIF).",
    backgroundReset: "Reset app background",
    backgroundStorageHint: "Images are stored locally in this device’s settings (maximum {size} MB).",
    ...
    customTheme: "Theme color overrides",
    customThemeHint: "Override common semantic colors for the active light/dark theme. Layout, fonts, and layers stay unchanged.",
    customThemeReset: "Clear color overrides",
    ...
    customThemeSecondary: "Secondary text",
    customThemeAccent: "Action accent",
