...
export const en = {
  ...
  aiConfig: {
    ...
    apiKey: "API Key",
    model: "Model",
    modelPick: "Choose from list…",
    modelPickEmpty: "Fetch models first",
    fetchModels: "Fetch models",
    fetchingModels: "Fetching…",
    fetchModelsOk: "Fetched {count} models. Pick from the list on the right or keep typing.",
    ...
    language: "Language",
    languageHint: "Descriptions, tags, and AI search keywords use the selected language.",
