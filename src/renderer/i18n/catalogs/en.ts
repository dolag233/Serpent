...
export const en = {
  ...
  settings: {
    ...
    pluginSafeModeHint: "Temporarily disable every third-party plugin without uninstalling it.",
    pluginInstall: "Install a plugin",
    pluginInstallHint: "Choose an already-built local folder or ZIP, or install a repository that already contains its compiled dist files.",
    pluginInstallScope: "Installation scope",
    pluginScopeUser: "This app",
    pluginScopeLibrary: "This library",
    pluginLibraryTrustHint: "This plugin will sync with this library. Each device must choose to trust it before it can run.",
    pluginInstallLocal: "Choose local plugin…",
    pluginGitHubRepository: "GitHub repository URL",
    ...
    pluginRuntimeTrusted: "Trusted runtime",
    pluginRuntimeTrustedHint: "Trusted runtime has full Node.js capability: it can read and write local files, use the network, and start other programs. Declared permissions only limit Serpent Gateway commands and are not a system sandbox. Trust only plugins whose source you accept for full machine access.",
    pluginRuntimeStandard: "Standard runtime",
    pluginRuntimeStandardHint: "Standard runtime runs in an isolated process sandbox and can only call Gateway commands you authorize.",
    pluginTrustTrustedConfirmHint: "After you trust it, this plugin will have full system capability on this device.",
    ...
    pluginStatusSafeMode: "Disabled by Safe Mode",
