...
export const en = {
  ...
  settings: {
    ...
    gitignoreFileHint: "Ignore actions for assets, folders, and extensions in this library are written here; edits apply to browsing, search, and scans immediately.",
