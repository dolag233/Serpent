...
export const en = {
  ...
  settings: {
    ...
    libraryIgnoreHint: "Use the .gitignore file in the library folder to hide files and folders.",
    gitignoreFile: ".gitignore file",
    gitignoreFileHint: "Changes are saved to the library folder and applied to browsing, search, and scans.",
    gitignoreSyntax: "Supports comments (#), wildcards (*, ?, **), directory rules (trailing /), root rules (leading /), and negation (!).",
