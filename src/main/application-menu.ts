 ...
 * Cmd+=,-,0 from renderer zoom shortcuts (Serpent-46i9).
 *
 * Windows (Serpent-znex): hide the menu bar entirely for frameless shell
 * unity. Chromium still handles Ctrl+C/V in inputs; right-click edit menu is
 * Serpent-d8u. Setting null also drops Electron View reload/zoom roles that
 * would otherwise remain as invisible accelerators if we only hid the bar.
 */
