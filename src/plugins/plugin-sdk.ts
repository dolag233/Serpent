...
export function generatePluginSdkTypeDeclaration(_moduleSpecifier = '@serpent/plugin-api'): string {
  ...
  return [
    ...
    '    readonly invocation?: { readonly contextId: string; readonly revision: number; readonly libraryId: string; readonly selection: { readonly ref?: string; readonly refs: readonly string[]; readonly assetIds: readonly string[]; readonly folderIds: readonly string[]; readonly collectionIds: readonly string[]; readonly assets?: readonly { readonly id: string; readonly name: string; readonly relativeFilePath: string; readonly mediaType: string; readonly byteSize: number; readonly durationMs?: number | null; readonly currentRevisionId?: string; readonly folderId?: string | null; readonly locationKind: \'managed\' | \'linked\'; readonly linkedFolderId?: string | null }[] }; readonly browse: Readonly<Record<string, unknown>>; readonly viewer: { readonly active: boolean; readonly assetId?: string } };',
    '  }',
    '',
