...
3. **P1 MVP 产品化**：0015/0016 已有一批实现进入当前基线，但仍是部分完成：壳层装饰清理、Inspector 紧凑布局、菜单分组/快捷键显示已落地；下一步先做 0016-A 资源库菜单、可点击面包屑、历史导航和普通/链接统一树，再完成 0015 命令注册表/本地化/主题、0017 文件夹与文件操作、0018 批量标签过滤。详细同步见 `docs/development/0015-0016-progress-sync.md`。
