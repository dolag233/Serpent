...
> 配套文档:`docs/implementation/0012-asset-canvas-views-and-card-display-vertical-slice.md`。
...
无阻塞项。若实施中浮现,写入 `docs/pending-requirements.md` 并在 `docs/implementation/mvp-roadmap.md` + `CLAUDE.md` 加指针。
