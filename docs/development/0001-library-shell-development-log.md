...
- Spec: `docs/implementation/0001-library-shell-vertical-slice.md`
...
- Visual direction is `Studio Contact Sheet`: a dense three-pane graphite workspace with restrained teal focus/selection and packaged CJK/mono typography. See `docs/ui/0001-studio-contact-sheet-direction.md`.
