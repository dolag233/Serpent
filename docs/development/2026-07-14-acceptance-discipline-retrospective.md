...
> 绑定规则已写入仓库级 agent 入口与 `docs/development-process.md`，并由 `docs/qa/human-acceptance-checklist.md` 提供持续验收队列，对所有后续切片和开发工具强制生效。
...
见 `AGENTS.md`、各工具入口、`docs/development-process.md`、`docs/qa/human-acceptance-checklist.md` 与本复盘。要点：
