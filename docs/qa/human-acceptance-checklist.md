...
- 文件操作：资产菜单已具备外部打开、在 Finder/Explorer 显示、复制文件路径（2026-07-17，协议单测绿、Computer Use 未执行）与重命名真实文件（2026-07-17 第二增量，全链路 + E2E 3/3，见 MENU-015）；仍缺默认/其他应用打开方式选择、复制/粘贴；文件夹重命名/复制/克隆/移动/删除领域命令尚未实现。
