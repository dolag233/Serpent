...
- 随应用分发版本锁定、LGPL-only 的 FFmpeg/ffprobe，负责媒体探测、视频封面、H.264/AAC MP4 预览代理、scrub、抽帧联系表和未来音频波形。
...
- 代理输出统一使用 H.264/AAC MP4；GIF 不生成代理，直接走原生图片预览。
...
- AVI/WMV 及原视频实际播放失败的其他视频，才生成 H.264/AAC MP4 代理；GIF 始终保留原生图片路径。
