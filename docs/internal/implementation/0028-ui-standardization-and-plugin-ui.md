...
- `docs/internal/implementation/0024-script-plugin-platform.md`、`docs/internal/adr/0027-plugin-instance-lifecycle-and-interaction-context.md`；
- `docs/manual/plugins/development.md`、`docs/manual/plugins/api-reference.md`；
- `docs/internal/ui/0001-studio-contact-sheet-direction.md`、`0003-keyboard-shortcut-ux-principles.md`、`0004-calm-error-and-copy-ux-principles.md`；
- 现有 `docs/internal/development/2026-08-02-ui-reuse-audit.md`；
...
本阶段的自动化证据记录在 `docs/internal/development/2026-08-04-ui-standardization-development-log.md`：定向单测、typecheck、lint 和插件设置/Shell Electron E2E 已执行；全量核心 E2E、Computer Use 视觉验收和其余业务 surface 迁移仍未完成。现有 `docs/internal/development/2026-08-02-ui-reuse-audit.md` 继续作为菜单 token 审计和历史缺口记录；实现工单必须在四列证据齐全后分别关闭，不能因为本设计文档存在就将 `Serpent-nzxh` 标记为完成。
