...
- 错误场景有稳定错误码和用户可理解提示。
- `docs/internal/development/0001-library-shell-development-log.md` 持续记录实现决定、命令结果、失败与偏离。
- `docs/internal/reviews/0001-library-shell-code-review.md` 保存 Standards / Spec 双轴审查、处理状态和复审结果。
- `docs/internal/qa/0001-library-shell-qa-report.md` 保存自动化与人工 QA 证据、未执行项和最终结论。
