...
> 日期：2026-08-05
> 调研依据：`docs/internal/research/2026-08-05-3d-model-preview-research.md`
...
> 每片交付：代码 + 测试 + 开发日志；状态流转按 `docs/internal/development-process.md`。切片完成需规格条目四列齐（需求 | 实现 file:line | 测试 test:line | 人工/平台证据）。
...
- 调研全文：`docs/internal/research/2026-08-05-3d-model-preview-research.md`
- 现有媒体管线：`docs/internal/research/media-preview-stack.md`
- 查看器切片：`docs/internal/implementation/0022-image-sequences-and-viewer-transforms.md`
