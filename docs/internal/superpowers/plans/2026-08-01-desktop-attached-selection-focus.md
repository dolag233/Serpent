...
- Any new human-operable function must update `docs/internal/qa/human-acceptance-checklist.md` in the same change set.
...
- Modify: `docs/internal/skills/serpent-automation/SKILL.md`
- Modify: `docs/internal/project-status.md`
- Modify: `docs/internal/qa/human-acceptance-checklist.md`
- Create: `docs/internal/development/2026-08-01-desktop-attached-selection-focus-development-log.md`
