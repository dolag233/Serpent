...
4. 继续补任务中心、完整 Job 重启和平台证据；本切片 QA 与审查报告见 `docs/internal/qa/0024-script-plugin-platform-qa-report.md`、`docs/internal/reviews/0024-script-plugin-platform-code-review.md`。
