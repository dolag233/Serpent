...
> 规格：`docs/internal/implementation/0023-automation-scripting-mcp-framework.md`
> 设计：`docs/internal/superpowers/specs/2026-07-31-automation-scripting-platform-design.md`
> 计划：`docs/internal/superpowers/plans/2026-07-31-automation-scripting-platform.md`
...
- `scripts/verify-package.mjs` 现在同时校验 Script Runtime / Plugin Host ASAR
  ...
  与 `docs/internal/skills/serpent-automation/automation-api.d.ts` 的一致性，以及协议专用
