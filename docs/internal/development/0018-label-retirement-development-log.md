...
> 切片规格：`docs/internal/implementation/mvp-ui-ux-requirements-backlog.md`（REQ-LABEL-001–003、0019 产品正确性）
> 设计决策：`docs/internal/adr/0022-retire-asset-label.md`
> 审查报告：`docs/internal/reviews/0018-0019-ui-correctness-code-review.md`
> QA 报告：`docs/internal/qa/0018-0019-ui-correctness-qa-report.md`
...
- `docs/internal/qa/human-acceptance-checklist.md`：跨 agent 唯一的人类验收队列。
