...
> 审查报告：`docs/internal/reviews/2026-07-18-inspector-shell-polish-code-review.md`
> QA 报告：`docs/internal/qa/2026-07-18-inspector-shell-polish-qa-report.md`
...
见 `docs/internal/qa/human-acceptance-checklist.md` 新增的 INSPECT-005、PALETTE-001、URL-OPEN-001、AICFG-001、FILTER-OUTSIDE-DISMISS-001、TOOLBAR-001 条目。
