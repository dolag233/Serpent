...
3. **文档对齐**：`docs/manual/scripts/development.md` 与 `docs/internal/skills/serpent-automation/SKILL.md` 列出完整 `serpent_desktop_*` 工具面，并说明 `scripts/mcp-session.mjs` 长连接；`package.json` 增加 `mcp:session`。
