...
- **文案面向用户（强制，2026-09-12 用户反馈）**：设置、按钮、空状态、提示只写用户会遇到的结果和可做的选择。不得把规格条目、实现约束或内部讨论写进界面，也不要把界面行为已经能看见的事再解释一遍。详见 [`docs/internal/ui/0004-calm-error-and-copy-ux-principles.md`](docs/internal/ui/0004-calm-error-and-copy-ux-principles.md) §6。
